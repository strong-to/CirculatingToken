...
export default function FinanceContent() {
  ...
  const listColumns: Column[] = [
    ...
    { key: 'assetName', label: 'Asset Name', width: 'flex' },
    { key: 'contractAddress', label: 'Contract Address', width: 'flex' },
    { key: 'recipientAddress', label: 'Recipient Address', width: 'flex' },
    { key: 'occurrenceQuantity', label: 'Occurrence Quantity', width: 'flex' },
  ...
  const listData = [
    {
      time: '14:59-08-07-2026',
      action: 'revenue',
      subject: 'Subject',
      assetName: 'Asset Name',
      contractAddress: 'Contract Address',
      recipientAddress: 'Recipient Address',
      occurrenceQuantity: 'Occurrence Quantity',
      cumulative: 'Cumulative',
      stock: 'Stock',
    },
    {
      time: '14:59-07-07-2026',
      action: 'expense',
      subject: 'Subject',
      assetName: 'Asset Name',
      contractAddress: 'Contract Address',
