...
export default function GPUComputeModal() {
  ...
  return (
    <div>
      ...
      >
        Provide NVIDIA A100 or equivalent GPU computing power for model training. At least 40GB VRAM GPU required for large-scale image recognition model training and fine-tuning...
      </div>
      ...
      <div className=" w-full flex flex-col items-center justify-center" style={{marginTop:px(439),gap:px(20)}}>
        ...
        >
          Provide NVIDIA A100 or equivalent GPU computing power for model training
        </div>
      </div>
