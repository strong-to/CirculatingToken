...
export default function WhereUsingBecomes() {
  ...
  // 卡片数据
  const cards = [
    { type: 'image', src: '/images/Investing/Investing1.png', alt: 'Investing card 1' },
    { type: 'image', src: '/images/Investing/Investing2.png', alt: 'Investing card 2' },
    { type: 'blueCard', src: '/images/Investing/Investing3.png', alt: 'Investing card 3' },
    { type: 'image', src: '/images/Investing/Investing4.png', alt: 'Investing card 4' },
    { type: 'image', src: '/images/Investing/Investing5.png', alt: 'Investing card 5' },
  ]
