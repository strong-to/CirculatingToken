/**
 * LiquidityThat 组件资源文件
 * 包含该组件使用的所有图片路径和文案
 * 文案直接从 public/home/LiquidityThat/text/texts.json 读取
 */
...
export const images = {
  // 背景图（初始化状态）
  background: '/home/LiquidityThat/img/bgc.png',
  // hover 状态 gif
  hover: '/home/LiquidityThat/img/hover.gif',
  // 通用图标
...
function getTextsData() {
  if (typeof window === 'undefined') {
    ...
    try {
      const data = loadTextsFromPublicSync('/home/LiquidityThat/text/texts.json');
