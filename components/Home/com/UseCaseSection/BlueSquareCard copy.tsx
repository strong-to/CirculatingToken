...
export default function BlueSquareCard({ src, alt }: BlueSquareCardProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-0 left-0 w-full aspect-square bg-[#CB2C22]/80 text-white flex flex-col justify-start cursor-pointer transition-all duration-300 ease-in-out"
      ...
      >
        ...
        <>
          ...
          <div
            ...
            style={{ height: px(30), marginTop: px(30) }}
          >
            <div
          ...
          <div
            className="w-full flex justify-between"
            style={{ height: px(30), marginTop: px(10) }}
          >
            <div
              className="border border-white flex items-center justify-center "
              style={{
        ...
        <>
          ...
          <div
            ...
            style={{ height: px(36), marginTop: px(26) }}
          >
            <div
          ...
          <div
            className=" flex justify-between items-center"
            style={{ height: px(36), marginTop: px(20) }}
          >
            <div
              className="flex flex-col items-center justify-between "
              style={{ height: "100%" }}
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-center gap-1">
                ...
                >
                  <path
                    d="M10.3613 6.62598L10.4736 6.97168H15.2432L11.6787 9.56152L11.3848 9.77539L11.4971 10.1201L12.8584 14.3096L9.29395 11.7207L9 11.5068L8.70605 11.7207L5.14062 14.3105L6.50391 10.1201L6.61523 9.77539L6.32227 9.56152L2.75781 6.97168H7.52637L7.63867 6.62598L9 2.43555L10.3613 6.62598Z"
                    stroke="white"
                  />
                </svg>
                <svg
