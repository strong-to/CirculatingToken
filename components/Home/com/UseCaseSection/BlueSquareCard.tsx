...
<div className='flex  justify-evenly'>
  <div className='border border-white flex items-center justify-center ' style={{width: px(55), height: px(55),borderRadius:px(3)}}>
  <div className='relative flex items-center justify-center' style={{width: px(44), height: px(32)}}>
      <Image 
    ...
    <div className="flex-1 text-center">
      <div className='leading-[1] tracking-[0] text-white' style={{
    ...
    <div className="h-full flex items-end justify-end" style={{width: px(24), height: px(24)}}>
      <Image src="/images/Investing/arr.png" alt="arrow" width={24} height={24} className="w-full h-full object-contain" />
    </div>
  </div>

  {/* 中间：两个按钮 */}
  <div className='flex'>
    <button className='border border-white text-white flex items-center justify-center ' style={{
      fontFamily: '"ITC Avant Garde Gothic Pro", sans-serif',
      fontWeight: 300,
      fontStyle: 'normal',
      fontSize: px(10.5),
  ...
  <div className='grid grid-cols-2 font-light '>
    <div>
      <div className=' flex items-center '>
        ...
        marginLeft: px(6),
        letterSpacing: '0%',
        color: 'rgba(255, 255, 255, 0.65)',}} >Market Cap</span>
      </div>
      <div className='font-semibold text-white' style={{fontFamily: '"ITC Avant Garde Gothic Pro", sans-serif',
        fontWeight: 300,
        marginTop: px(11),
        fontStyle: 'normal',
        fontSize: px(17),
        lineHeight: px(20),
        letterSpacing: '0%',}} >$12.3k</div>
    </div>
    <div>
      <div className='flex items-center '>
        ...
        marginLeft: px(6),
        letterSpacing: '0%',
        color: 'rgba(255, 255, 255, 0.65)',}} >24h Revenue</span>
      </div>
      <div className='font-semibold text-white ' style={{fontFamily: '"ITC Avant Garde Gothic Pro", sans-serif',
        fontWeight: 300,
        marginTop: px(11),
    ...
    <div style={{marginTop: px(21)}}>
      <div className='flex items-center '>
        ...
        marginLeft: px(6),
        letterSpacing: '0%',
        color: 'rgba(255, 255, 255, 0.65)',}} >Total Users</span>
      </div>
      <div className='font-semibold text-white ' style={{fontFamily: '"ITC Avant Garde Gothic Pro", sans-serif',
        fontWeight: 300,
        marginTop: px(11),
    ...
    <div style={{marginTop: px(21)}}>
      <div className='flex items-center'>
        ...
        marginLeft: px(6),
        letterSpacing: '0%',
        color: 'rgba(255, 255, 255, 0.65)',}} >User Rating</span>
      </div>
      <div className='font-semibold text-white ' style={{fontFamily: '"ITC Avant Garde Gothic Pro", sans-serif',
        fontWeight: 300,
        marginTop: px(11),
