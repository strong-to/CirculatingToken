...
export default function MortgageMarketContent() {
  ...
  const [isFilterIconHovered, setIsFilterIconHovered] = useState(false);
      ...
      >
        ...
        >
          ...
          <div className="flex items-center " style={{ gap: px(12) }}>
            ...
            >
              {isPlusIconHovered ? (
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transition: "all 0.2s ease-in-out" }}>
                  <path d="M12.5 1.5625C18.5408 1.5625 23.4375 6.45936 23.4375 12.5C23.4375 18.5406 18.5408 23.4375 12.5 23.4375C6.45948 23.4375 1.5625 18.5405 1.5625 12.5C1.5625 6.45948 6.45948 1.5625 12.5 1.5625ZM12.5 3.125C7.32242 3.125 3.125 7.32242 3.125 12.5C3.125 17.6257 7.23876 21.7911 12.3447 21.874L12.5 21.875L12.6553 21.874C17.7098 21.792 21.792 17.7097 21.874 12.6553L21.875 12.5C21.875 7.3223 17.6778 3.125 12.5 3.125ZM12.5 7.42188C12.9118 7.42188 13.2493 7.74042 13.2793 8.14453L13.2812 8.20312V11.7188H16.7969C17.2283 11.7188 17.5781 12.0685 17.5781 12.5C17.5781 12.9118 17.2596 13.2493 16.8555 13.2793L16.7969 13.2812H13.2812V16.7969C13.2812 17.2283 12.9315 17.5781 12.5 17.5781C12.0882 17.5781 11.7507 17.2596 11.7207 16.8555L11.7188 16.7969V13.2812H8.20312C7.77165 13.2812 7.42188 12.9315 7.42188 12.5C7.42188 12.0882 7.74042 11.7507 8.14453 11.7207L8.20312 11.7188H11.7188V8.20312C11.7188 7.77165 12.0685 7.42188 12.5 7.42188Z" fill="#000000"/>
                </svg>
              ) : (
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12.5 1.5625C18.5408 1.5625 23.4375 6.45936 23.4375 12.5C23.4375 18.5406 18.5408 23.4375 12.5 23.4375C6.45948 23.4375 1.5625 18.5405 1.5625 12.5C1.5625 6.45948 6.45948 1.5625 12.5 1.5625ZM12.5 3.125C7.32242 3.125 3.125 7.32242 3.125 12.5C3.125 17.6257 7.23876 21.7911 12.3447 21.874L12.5 21.875L12.6553 21.874C17.7098 21.792 21.792 17.7097 21.874 12.6553L21.875 12.5C21.875 7.3223 17.6778 3.125 12.5 3.125ZM12.5 7.42188C12.9118 7.42188 13.2493 7.74042 13.2793 8.14453L13.2812 8.20312V11.7188H16.7969C17.2283 11.7188 17.5781 12.0685 17.5781 12.5C17.5781 12.9118 17.2596 13.2493 16.8555 13.2793L16.7969 13.2812H13.2812V16.7969C13.2812 17.2283 12.9315 17.5781 12.5 17.5781C12.0882 17.5781 11.7507 17.2596 11.7207 16.8555L11.7188 16.7969V13.2812H8.20312C7.77165 13.2812 7.42188 12.9315 7.42188 12.5C7.42188 12.0882 7.74042 11.7507 8.14453 11.7207L8.20312 11.7188H11.7188V8.20312C11.7188 7.77165 12.0685 7.42188 12.5 7.42188Z" fill="#8C8C8C"/>
                </svg>
              )}
            </div>
            <button
              ...
              style={{
                padding: `${px(8)} ${px(16)}`,
                border: `0.5px solid ${isButtonHovered ? "#000000" : "#000000"}`,
          ...
          <div className="flex items-center" style={{ gap: px(8) }}>
            {/* Filter Icon */}
            <div
              onMouseEnter={() => setIsFilterIconHovered(true)}
              onMouseLeave={() => setIsFilterIconHovered(false)}
              style={{
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
            ...
            >
              {isFilterIconHovered ? (
                ...
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12.5 1.5625C18.5408 1.5625 23.4375 6.45936 23.4375 12.5C23.4375 18.5406 18.5408 23.4375 12.5 23.4375C6.45948 23.4375 1.5625 18.5405 1.5625 12.5C1.5625 6.45948 6.45948 1.5625 12.5 1.5625ZM12.5 3.125C7.32242 3.125 3.125 7.32242 3.125 12.5C3.125 17.6257 7.23876 21.7911 12.3447 21.874L12.5 21.875L12.6553 21.874C17.7098 21.792 21.792 17.7097 21.874 12.6553L21.875 12.5C21.875 7.3223 17.6778 3.125 12.5 3.125Z" fill="#8C8C8C"/>
                  <path d="M19 15H13V16H19V15Z" fill="#8C8C8C"/>
                  <path d="M9 15H7V16H9V15Z" fill="#8C8C8C"/>
                  <rect x="7" y="9" width="5" height="1" fill="#8C8C8C"/>
                  <path d="M16 9H19V10H16V9Z" fill="#8C8C8C"/>
                  <circle cx="13.8571" cy="9.57143" r="1.82143" stroke="#8C8C8C" strokeWidth="1.5"/>
                  <circle cx="2.57143" cy="2.57143" r="1.82143" transform="matrix(-1 0 0 1 13.8572 13)" stroke="#8C8C8C" strokeWidth="1.5"/>
                </svg>
              )}
            </div>
            {/* Upload Icon */}
            ...
            >
              {isUploadIconHovered ? (
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transition: "all 0.2s ease-in-out" }}>
                  <path d="M12.9375 2C18.9783 2 23.875 6.89686 23.875 12.9375C23.875 18.9781 18.9783 23.875 12.9375 23.875C6.89698 23.875 2 18.978 2 12.9375C2 6.89698 6.89698 2 12.9375 2ZM12.9375 3.5625C7.75992 3.5625 3.5625 7.75992 3.5625 12.9375C3.5625 18.0632 7.67626 22.2286 12.7822 22.3115L12.9375 22.3125L13.0928 22.3115C18.1473 22.2295 22.2295 18.1472 22.3115 13.0928L22.3125 12.9375C22.3125 7.7598 18.1153 3.5625 12.9375 3.5625Z" fill="black"/>
                  <path d="M12.9375 2C18.9783 2 23.875 6.89686 23.875 12.9375C23.875 18.9781 18.9783 23.875 12.9375 23.875C6.89698 23.875 2 18.978 2 12.9375C2 6.89698 6.89698 2 12.9375 2ZM12.9375 3.5625C7.75992 3.5625 3.5625 7.75992 3.5625 12.9375C3.5625 18.0632 7.67626 22.2286 12.7822 22.3115L12.9375 22.3125L13.0928 22.3115C18.1473 22.2295 22.2295 18.1472 22.3115 13.0928L22.3125 12.9375C22.3125 7.7598 18.1153 3.5625 12.9375 3.5625Z" fill="black" fillOpacity="0.2"/>
                  <path d="M12.9375 2C18.9783 2 23.875 6.89686 23.875 12.9375C23.875 18.9781 18.9783 23.875 12.9375 23.875C6.89698 23.875 2 18.978 2 12.9375C2 6.89698 6.89698 2 12.9375 2ZM12.9375 3.5625C7.75992 3.5625 3.5625 7.75992 3.5625 12.9375C3.5625 18.0632 7.67626 22.2286 12.7822 22.3115L12.9375 22.3125L13.0928 22.3115C18.1473 22.2295 22.2295 18.1472 22.3115 13.0928L22.3125 12.9375C22.3125 7.7598 18.1153 3.5625 12.9375 3.5625Z" fill="black" fillOpacity="0.2"/>
                  <path d="M12.9375 2C18.9783 2 23.875 6.89686 23.875 12.9375C23.875 18.9781 18.9783 23.875 12.9375 23.875C6.89698 23.875 2 18.978 2 12.9375C2 6.89698 6.89698 2 12.9375 2ZM12.9375 3.5625C7.75992 3.5625 3.5625 7.75992 3.5625 12.9375C3.5625 18.0632 7.67626 22.2286 12.7822 22.3115L12.9375 22.3125L13.0928 22.3115C18.1473 22.2295 22.2295 18.1472 22.3115 13.0928L22.3125 12.9375C22.3125 7.7598 18.1153 3.5625 12.9375 3.5625Z" fill="black" fillOpacity="0.2"/>
                  <path d="M12.9375 2C18.9783 2 23.875 6.89686 23.875 12.9375C23.875 18.9781 18.9783 23.875 12.9375 23.875C6.89698 23.875 2 18.978 2 12.9375C2 6.89698 6.89698 2 12.9375 2ZM12.9375 3.5625C7.75992 3.5625 3.5625 7.75992 3.5625 12.9375C3.5625 18.0632 7.67626 22.2286 12.7822 22.3115L12.9375 22.3125L13.0928 22.3115C18.1473 22.2295 22.2295 18.1472 22.3115 13.0928L22.3125 12.9375C22.3125 7.7598 18.1153 3.5625 12.9375 3.5625Z" fill="black" fillOpacity="0.2"/>
                  <path d="M18 12.4883L17.4367 13.052L12.5 8.1258L7.56329 13.052L7 12.4883L12.5 7L18 12.4883Z" fill="black"/>
                  <path d="M18 12.4883L17.4367 13.052L12.5 8.1258L7.56329 13.052L7 12.4883L12.5 7L18 12.4883Z" fill="black" fillOpacity="0.2"/>
                  <path d="M18 12.4883L17.4367 13.052L12.5 8.1258L7.56329 13.052L7 12.4883L12.5 7L18 12.4883Z" fill="black" fillOpacity="0.2"/>
                  <path d="M18 12.4883L17.4367 13.052L12.5 8.1258L7.56329 13.052L7 12.4883L12.5 7L18 12.4883Z" fill="black" fillOpacity="0.2"/>
                  <path d="M18 12.4883L17.4367 13.052L12.5 8.1258L7.56329 13.052L7 12.4883L12.5 7L18 12.4883Z" fill="black" fillOpacity="0.2"/>
                  <path d="M18 12.4883L17.4367 13.052L12.5 8.1258L7.56329 13.052L7 12.4883L12.5 7L18 12.4883Z" stroke="black" strokeWidth="0.5"/>
                  <path d="M18 12.4883L17.4367 13.052L12.5 8.1258L7.56329 13.052L7 12.4883L12.5 7L18 12.4883Z" stroke="black" strokeOpacity="0.2" strokeWidth="0.5"/>
                  <path d="M18 12.4883L17.4367 13.052L12.5 8.1258L7.56329 13.052L7 12.4883L12.5 7L18 12.4883Z" stroke="black" strokeOpacity="0.2" strokeWidth="0.5"/>
                  <path d="M18 12.4883L17.4367 13.052L12.5 8.1258L7.56329 13.052L7 12.4883L12.5 7L18 12.4883Z" stroke="black" strokeOpacity="0.2" strokeWidth="0.5"/>
                  <path d="M18 12.4883L17.4367 13.052L12.5 8.1258L7.56329 13.052L7 12.4883L12.5 7L18 12.4883Z" stroke="black" strokeOpacity="0.2" strokeWidth="0.5"/>
                  <path d="M12.8985 7.96875V18.8183H12.1018V7.96875H12.8985Z" fill="black"/>
                  <path d="M12.8985 7.96875V18.8183H12.1018V7.96875H12.8985Z" fill="black" fillOpacity="0.2"/>
                  <path d="M12.8985 7.96875V18.8183H12.1018V7.96875H12.8985Z" fill="black" fillOpacity="0.2"/>
                  <path d="M12.8985 7.96875V18.8183H12.1018V7.96875H12.8985Z" fill="black" fillOpacity="0.2"/>
                  <path d="M12.8985 7.96875V18.8183H12.1018V7.96875H12.8985Z" fill="black" fillOpacity="0.2"/>
                  <path d="M12.8985 7.96875V18.8183H12.1018V7.96875H12.8985Z" stroke="black" strokeWidth="0.5"/>
                  <path d="M12.8985 7.96875V18.8183H12.1018V7.96875H12.8985Z" stroke="black" strokeOpacity="0.2" strokeWidth="0.5"/>
                  <path d="M12.8985 7.96875V18.8183H12.1018V7.96875H12.8985Z" stroke="black" strokeOpacity="0.2" strokeWidth="0.5"/>
                  <path d="M12.8985 7.96875V18.8183H12.1018V7.96875H12.8985Z" stroke="black" strokeOpacity="0.2" strokeWidth="0.5"/>
                  <path d="M12.8985 7.96875V18.8183H12.1018V7.96875H12.8985Z" stroke="black" strokeOpacity="0.2" strokeWidth="0.5"/>
                </svg>
