...
export const cardData: ContentCardProps[] = [
  // Row 1, Col 1: TENSOR GRID (DBAI0000002)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_1.png',
      title: 'TENSOR GRID',
  ...
  // Row 1, Col 2: EDU FORM (DBAI0000012)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_2.png',
      title: 'EDU FORM',
  ...
  // Row 1, Col 5: RES LAB (DBAI0000014)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_5.png',
      title: 'RES LAB',
  ...
  // Row 2, Col 1: FRAME FLOW (DBAI0000017)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_6.png',
      title: 'FRAME FLOW',
      subtitle: 'DBAI0000017',
  ...
  // Row 2, Col 3: ART REFER (DBAI0000013)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_8.png',
      title: 'ART REFER',
  ...
  // Row 2, Col 4: INDUS DRAFT (DBAI0000018)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_9.png',
      title: 'INDUS DRAFT',
  ...
  // Row 2, Col 5: SPECTRA (DBAI0000004)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_10.png',
      title: 'SPECTRA',
  ...
  // Row 3, Col 1: PIXEL STREAM (DBAI0000016)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_11.png',
      title: 'PIXEL STREAM',
  ...
  // Row 3, Col 2: VERBA (DBAI0000003)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_12.png',
      title: 'VERBA',
  ...
  // Row 3, Col 5: PRIME CORE (DBAI0000001)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_15.png',
      title: 'PRIME CORE',
  ...
  // Row 4, Col 2: ARCHI PILOT (DBAI0000019)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_17.png',
      title: 'ARCHI PILOT',
  ...
  // Row 4, Col 3: ECHO MIND (DBAI0000005)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_18.png',
      title: 'ECHO MIND',
  ...
  // Row 4, Col 4: TRIP MATE (DBAI0000024)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_19.png',
      title: 'TRIP MATE',
  ...
  // Row 4, Col 5: KID LEARN (DBAI0000030)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_20.png',
      title: 'KID LEARN',
  ...
  // Row 5, Col 1: PET BOT (DBAI0000029)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_21.png',
      title: 'PET BOT',
  ...
  // Row 5, Col 2: ART REFER (DBAI0000013) - 重复项
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_22.png',
      title: 'ART REFER',
      subtitle: 'DBAI0000013',
      descriptions: ['THIS IS AN ART INSTRUCTION AI DATASET'],
      buttons: ['Text', 'Art&Culture', 'Data', 'Summarize']
  ...
  // Row 5, Col 3: STYLE CRAFT (DBAI0000028)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_23.png',
      title: 'STYLE CRAFT',
  ...
  // Row 5, Col 4: STAR SAGE (DBAI0000022)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_24.png',
      title: 'STAR SAGE',
  ...
  // Row 5, Col 5: VOCA BBRIDGE (DBAI0000023)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_25.png',
      title: 'VOCA BBRIDGE',
  ...
  // Row 6, Col 2: SPORT CUE (DBAI0000010)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_27.png',
      title: 'SPORT CUE',
  ...
  // Row 6, Col 3: FIN PILOT (DBAI0000026)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_28.png',
      title: 'FIN PILOT',
  ...
  // Row 6, Col 4: MEDI PROMPT (DBAI0000007)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_29.png',
      title: 'MEDI PROMPT',
  ...
  // Row 6, Col 5: LEX GUIDE (DBAI0000006)
  {
    ...
    clickColor: '#CB2C22',
    initial: {
      icon: '/images/TokenMarketplace/content/icon/icon_30.png',
      title: 'LEX GUIDE',
