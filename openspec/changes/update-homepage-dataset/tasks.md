## 1. 数据编排
- [ ] 1.1 新建 `dataset/index.json`，描述首页各板块、卡片顺序以及支持的筛选维度。
- [ ] 1.2 调整相关 `dataset/projects/*.json`，让 `profile.media` 的图片与简介复用当前 `/public/images/...` 资源，若与现有页面文案冲突必须以当前页面为准，确保文案/视觉一致。
